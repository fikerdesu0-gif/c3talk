...
import { Mic, MessageSquareText, ChevronRight, Download, LogOut, History as HistoryIcon } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  if (mode === AppMode.HISTORY) {
    return <History onBack={() => setMode(AppMode.HOME)} />;
  }
      ...
      <div className="flex-1 flex flex-col bg-black text-white">
        ...
        <div className="flex-1 px-6 py-8 flex flex-col justify-center space-y-8 fade-in">
          ...
          <button
            ...
            className="group relative w-full p-6 bg-neutral-900 border border-neutral-800 rounded-3xl shadow-lg active:scale-[0.98] transition-all duration-300 overflow-hidden text-left flex items-center justify-between"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <span className="block text-xl font-bold text-white">History</span>
                <span className="block text-neutral-400 text-sm">View past translations</span>
              </div>
            </div>
